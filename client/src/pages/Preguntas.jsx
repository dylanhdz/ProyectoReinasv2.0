    ...
    return (
      <div className="main-container">
                ...
                <div className="select" onClick={handleSelectClick}>
                  <span className="selected">
                    {elements[listaCandidatas.findIndex(c => c.CANDIDATA_ID === candidata.CANDIDATA_ID)] !== 0 ? 
                      `${elements[listaCandidatas.findIndex(c => c.CANDIDATA_ID === candidata.CANDIDATA_ID)]} de 10` : 'Calificar'}
                  </span>
                </div>
        ...
        <Popup open={modalIsOpen} onClose={handleModalClose}>
          ...
          <div className="modal">
            <h2 className="modal-title">¿Está seguro de registrar sus calificaciones?</h2>
        ...
        <Popup open={vacioIsOpen} onClose={handleVacioClose}>
          ...
          <div className="modal">
            ...
            <h2 className="modal-title">Por favor, califique a todas las candidatas antes de enviar.</h2>
            <div className="botones-modal">
