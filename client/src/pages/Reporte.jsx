...
function Reporte() {
    ...
    // Crear Componente del Documento
                            ...
                            <Page size="A4" style={styles.page}>
                                <View>
                                    <Text style={styles.header} fixed>
                                        Sistema de Votación - Reina ESPE 2025 - {horaFormato}
                                    </Text>
                                    ...
                                    <View style={styles.section}>
                                        ...
                                        <Text style={styles.subtitle}>Puntajes Arrojados por el Sistema Informático</Text>
                                        <Text style={styles.subtitle}>Hora de Corte del Sistema (GMT-05): {horaFormato}</Text>
                                    </View>
                                    <React.Fragment>
                                        {listaReinas
                                            ...
                                            .map((reina, index) => (
                                                <View style={styles.contenedorColumna} key={reina.CANDIDATA_ID}>
                                                    <View style={styles.columna}>
                                                        {index === 0 && (
                                                            <Text style={styles.bold}>Reina ESPE 2025</Text>
                                                        )}
                                                        {index === 1 && (
                                                        ...
                                                        <Text style={styles.text}>{reina.CAND_NOTA_FINAL} Puntos</Text>
                                                    </View>
                                                    <View style={styles.columna}>
                                        ...
                                        {listaDepartamentos
                                            ...
                                            .map((reina, index) => (
                                                <View style={styles.section_ganadoras} key={reina.CANDIDATA_ID} break={index > 1 ? 'page' : undefined}>
                                                    <View>
                                                        {index === 0 && (
                                                            <Text style={styles.title}>Reina ESPE 2025</Text>
                                                        )}
                                                        {index === 1 && (
                                                        ...
                                                        <Text style={styles.tituloreina}>Puntuación Final de: {reina.CAND_NOTA_FINAL} Puntos</Text>
                                                    </View>
